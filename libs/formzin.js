...
var Formzin = new function () {
    this.iniciar = function () {
        jQuery(document).ready(function () {
            ...
            Formzin.fMoeda();
            Formzin.vCampo();
            Formzin.validar(jQuery('.validar-email'), Formzin.validarEmail, 'Por favor preencha um e-mail válido.');
            Formzin.validar(jQuery('.validar-url'), Formzin.validarUrl, 'Por favor preencha uma url válida.');
            Formzin.validar(jQuery('.validar-cpf'), Formzin.validarCpf, 'Por favor preencha o CPF corretamente.');
            Formzin.validar(jQuery('.validar-cnpj'), Formzin.validarCnpj, 'Por favor preencha o CNPJ corretamente.');
            Formzin.validar(jQuery('.validar-data'), Formzin.validarData, 'Por favor preencha a data corretamente.');
            Formzin.validar(jQuery('.validar-cartao-credito'), Formzin.validarCartaoCredito, 'Por favor preencha o cartão de crédito corretamente.');
...
// VERIFICAR O CAMPO ESTA DIFERENTE DO FORMATO PARA LIMPAR
        ...
        campo.bind('blur focus keydown keyup change', function () {
            ...
            if (v === "") {
                ...
                if (jQuery(this).attr('data-msn_validacao'))
                    jQuery(this).after('<span class="error-validacao error-validacao-' + id + '" style="color:red;">' +
                        jQuery(this).attr('data-msn_validacao') + '</span>');
                else
                ...
                if (jQuery(this).val().length < jQuery(this).attr('data-minlength'))
                    jQuery(this).after('<span class="error-validacao error-validacao-' + id + '" style="color:red;">Por favor o campo deve ter no mínimo (' + jQuery(this).attr('data-minlength') + ') caracteres.</span>');
    ...
    this.montarParcelas = function () {
        ...
        for (var p = 1; p <= totalParcelas; p++) {
            ...
            option += '<option ' + ((val && val === p) ? 'selected' : '') + ' value="' + p + '">' + p + 'x de R$ ' + valorParcela + ' '
                + msnParcela + '</option>';
        }
        return option;
    };
    this.msnValidacao = function (obj, valido, msn) {
        ...
        if (valido === false) {
            ...
            if (obj.attr('data-msn_validacao'))
                obj.after('<span class="error-validacao error-validacao-' + id + '" style="color:red;">' + obj.attr('datamsn_validacao') + '</span>');
        else
